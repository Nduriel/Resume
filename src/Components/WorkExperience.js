            ...
            <Media>
              ...
              <Media body>
                <ul>
                  ...
                  Norfolk, Virginia
                  <li>
                    Installed and repaired foundations for operating machinery
                    and principal structures and components.
                  </li>
                  <li>
                  ...
                  <li>
                    {" "}
                    Used precision measuring instruments such as height gages,
                    depth gages, calipers and various types of micrometers.
                    Troubleshot and repaired machines to increase productivity
                  ...
                  <li>
                    ...
                    customers to find workable solutions.
                  </li>
                  <li>
            ...
            <Media>
              ...
              <Media body>
                <ul>
                  ...
                  (12/2015 - 07/2018)
                  <li>
                    Assistant Grocery Manager for two stores at the same time;
                    Ghent and Military Highway Stores.
                  </li>
                  <li>
                    Expertly filled roles such as cashier, stock crew,
                    bookkeeper, sales & service desk, customer service
                    representative (CSR) and closing store manager.
                  </li>
                  <li>
                  ...
                  <li>
                    Drove consistent grocery sales with effective merchandising
                  ...
                  <li>
                    Coordinated efficient restocking of grocery merchandise to
                    meet customer needs and promote consistent sales.
                  </li>
                  <li>
                  ...
                  <li>
                    Lead by example and took responsibility for all actions
                    drive culture of performance excellence.
                  </li>
                  <li>
            ...
            <Media>
              ...
              <Media body>
                <ul>
                  ...
                  (02/2013 - 01/2015)
                  <li>
                    Performed skilled and semi-skilled repairs to existing
                    roofs, including shingle replacement.
                  </li>
                  <li>
                    Completed residential and commercial roofing work on time
                    and within expected project parameters, increasing repeat
                  ...
                  <li>
                    Collected and removed debris and roofing materials to
                    disposal areas at end of every shift to maintain clean work
                    area.
                  </li>
                  <li>
            ...
            <Media>
              ...
              <Media body>
                <ul>
                  ...
                  (02/2006 - 02/2012)
                  <li>
                    Functioned as a Squad Leader, Fireteam Leader and a
                    Breaching Instructor.
                  </li>
                  <li>
                    Used visual methods and mine detectors to identify and
                    locate mines, effectively detonating enemy threats.
                  </li>
                  <li>
                    Located and neutralized various types of mines and IEDs.
                  </li>
                  <li>
                  ...
                  <li>
                    Installed and recovered anti-handing devices on anti-tank
                    mines and electrical and non-electrical demolition charges.
                  </li>
                  <li>
                    Made roads, bridges and ferries safe for travel by
                    conducting ground reconnaissance and reporting back to
                    Platoon Sergeant.
                  </li>
                  <li>
                  ...
                  <li>
                    Developed top talent by leading training initiatives for
                    combat preparation.
                  </li>
                  <li>
                    Completed dozens of patrols of assigned areas within
                    operations areas during Operation Iraqi Freedom.
                  </li>
                  <li>
                    Instructed personnel on ways to reduce environmental hazards
            ...
            <Media>
              ...
              <Media body>
                <ul>
                  ...
                  <i>
                    <h5>
                      FullStack Web Development - Certificate of Completion
                    </h5>{" "}
                  </i>
                  Online Eastern <br />
                  (08/2019 - 04/2020)
